    ...
    <main class="main-content">
        ...
        <div class="dashboard-content">
            ...
            <div class="alert alert-info" style="margin-bottom: 1rem;">
                Store Profit only counts customer and guest bundle orders placed through your agent store link. Your own data, AFA, and checker purchases earn commission instead.
            </div>
            ...
            <div class="stats-grid" style="margin-bottom: 2rem;">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <div class="stat-label">Bundle Profit</div>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <div class="stat-value"><?php echo CURRENCY . number_format($data_profit, 2); ?></div>
                        <div class="stat-label">Store Link Orders</div>
                    </div>
                </div>
                <div class="stat-card">
                            ...
                            <form method="post" id="withdrawForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="amount" name="amount"
                                           ...
                                           required>
                                <div class="form-help">
                                    This is your current withdrawable profit balance. It is filled automatically from your available earnings.
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-help">Wallet option is automatic. Mobile money requests require admin approval and pay out Amount - Fee. The withdrawal fee is borne by the agent.</div>
                                </div>
                ...
                <div class="widget">
                    <div class="widget-content">
                        ...
                        <p style="color: var(--text-muted); margin-bottom: 0;">
                            Current wallet balance is separate from store profit and commission earnings.
                        </p>
