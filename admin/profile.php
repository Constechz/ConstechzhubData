...
<head>
    ...
    <title>Profile - Admin - <?php echo htmlspecialchars(getSiteName()); ?></title>
...
<div class="dashboard-wrapper">
    ...
    <nav class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="api-applications.php">
                    <i class="fas fa-code"></i> API Applications
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="system-reset.php">
                    <i class="fas fa-broom"></i> System Reset
                </a>
            </li>
            <li class="nav-item">
            ...
            <div class="content-area">
                ...
                <div class="card" style="margin-top: 2rem; border-color: #D90368;">
                    ...
                    <div class="card-body">
                        ...
                        <p style="color: #541388; margin-bottom: 1rem;">Once you delete your account, there is no going back. This action cannot be undone.</p>
