...
$display_name = trim((string) ($current_user['full_name'] ?? ($_SESSION['username'] ?? 'Admin')));
if ($display_name === '') {
    $display_name = 'Admin';
}
    ...
    <main class="main-content">
        ...
        <div class="dashboard-content">
            <div class="page-title">
                ...
                <p class="page-subtitle">Recover a paid data order when Paystack deducted money but the agent, customer, or guest bundle order was not submitted.</p>
            </div>
            ...
            <div class="widget recovery-card">
                <div class="widget-header">
                    <div>
                        ...
                        <p class="widget-subtitle">Paste the Paystack reference from the transaction or Paystack dashboard.</p>
                    </div>
                </div>
                <div class="widget-content">
                    <ol class="recovery-steps">
                        ...
                        <li>If missing, it creates and submits the bundle order for the correct agent or customer, then links it to the transaction.</li>
                    </ol>
                    ...
                    <form id="recoveryForm" class="form" style="margin-top: 1rem;">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text">Supports Paystack data bundle purchases generated by this system, including guest checkout and direct agent/customer Paystack orders.</small>
                        </div>
        ...
        function showResult(type, message, redirectPath) {
            ...
            if (redirectPath) {
                html += '<div class="result-actions">'
                    ...
                    + '<i class="fas fa-arrow-up-right-from-square"></i> Open Order Status</a>'
