...
<html lang="en">
<head>
  <?php echo generateSeoMeta('Constchat', 'Chat with our AI bot, submit questions, locations, suggestions and get responses.'); ?>
    ...
    <nav class="sidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li class="nav-section">
          ...
          <div class="nav-item">
            <a class="nav-link active" href="constchat.php<?php echo $store_slug ? '?store=' . urlencode($store_slug) : ''; ?>">
          ...
          <div id="chatTab" class="constchat-content active">
            <div class="chat-messages" id="chatMessages">
              <div class="message bot">
                Hello <strong><?php echo htmlspecialchars($current['full_name']); ?></strong>! Welcome to <strong>Constchat</strong>. I am your automated Constechzhub assistant.<br><br>
                Ask me about buying data, wallet deposits, result checkers, or how to locate agent stores. You can also recommend new store places or submit suggestions. What would you like to know?
              </div>
            </div>
            ...
            <div style="margin-top: 12px;">
              <div class="chat-suggestions" id="chatSuggestions">
                <div class="suggestion-pill" onclick="sendSuggestion('How to buy data?')">How to buy data?</div>
  ...
  <script>
    ...
    function adjustFormLabels() {
      ...
      if (type === 'question') {
        ...
        inputTitle.placeholder = "e.g. Payment deduction question";
        ...
        inputTitle.placeholder = "e.g. Direct wallet auto-funding via MoMo";
    ...
    // Theme toggle & Dropdown logic from dashboard.js / support.php
    function initTheme() {
