...
<body>
    <div class="card">
        ...
        <?php if ($redirectUrl): ?>
            ...
            <p>We opened the payment securely inside this page. If it doesn't load, use the button below to continue.</p>
            ...
            <div class="actions">
                ...
                <a class="btn btn-outline" href="<?php echo SITE_URL; ?>/customer/wallet.php">Back to Wallet</a>
            </div>
            <?php if ($reference): ?>
            ...
            const poll = async () => {
                ...
                try {
                    ...
                    if (data && data.transaction_status === 'failed') {
                        window.location.href = <?php echo json_encode(SITE_URL . '/customer/wallet.php'); ?>;
                        return;
                    }
                } catch (e) { /* ignore */ }
