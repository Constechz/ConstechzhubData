  ...
  <div class="dashboard-wrapper">
    <nav class="sidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li class="nav-item"><a class="nav-link" href="wallet.php"><i class="fas fa-wallet"></i> Wallet</a></li>
        <li class="nav-item">
            <a class="nav-link" href="result-checker.php">
                <i class="fas fa-award"></i> Result Checker
            </a>
        </li>
        <li class="nav-item"><a class="nav-link" href="customer_topup.php"><i class="fas fa-user-plus"></i> Customer Top-up</a></li>
